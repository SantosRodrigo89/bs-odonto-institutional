...
export default function FloatingWhatsApp() {
  return (
    ...
    >
      ...
      <span className="absolute right-full mr-3 top-1/2 -translate-y-1/2 bg-neutral-dark text-white px-3 py-2 rounded-lg text-sm whitespace-nowrap opacity-0 group-hover:opacity-100 transition-opacity pointer-events-none">
        Fale conosco
      </span>
    </a>
  )
